...
// import { apiFetch } from "../../api/api.js";
// import { displayChat } from "./chatPage.js";
...
//             li.style.cursor = "pointer";
//             li.style.borderBottom = "1px solid #eee";
//             li.style.background = isRead ? "#fff" : "#f0f8ff"; // Light blue if unread

//             li.addEventListener("click", () => {
//                 displayChat(contentContainer, chat._id, isLoggedIn);
//             });
...
//             name.textContent = `Chat with: ${otherUser}`;
//             name.style.fontWeight = isRead ? "normal" : "bold";
...
// //     chatListContainer.id = "chat-list-container";

// //     const list = document.createElement("ul");
// //     list.id = "chat-list";

// //     chatListContainer.appendChild(list);
// //     contentContainer.appendChild(chatListContainer);

// //     try {
// //         const chats = await apiFetch("/chats/all");

// //         if (!Array.isArray(chats) || chats.length === 0) {
// //             list.innerHTML = "<li>No chats found.</li>";
// //             return;
// //         }

// //         chats.forEach(chat => {
// //             const li = document.createElement("li");
// //             li.textContent = `Chat with: ${chat.users.filter(id => id !== localStorage.getItem("user")).join(", ")}`;
// //             li.style.cursor = "pointer";
...
// //     } catch (err) {
// //         console.error(err);
// //         list.innerHTML = "<li>Failed to load chats.</li>";
// //     }
// // }
