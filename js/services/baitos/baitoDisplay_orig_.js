...
function renderOwnerControls(baito) {
  return createElement("div", { class: "baito-owner-controls" }, [
    Button("✏️ Edit Job", "baito-edit-btn", { click: () => editBaito(baito) }, "btn btn-secondary"),
    Button("📨 View Applicants", "view-applicants-btn", { click: () => showApplicantsModal(baito) }, "btn btn-secondary"),
...
function renderApplicantControls(baito, baitoid, isLoggedIn) {
  return createElement("div", { class: "baito-user-controls" }, [
    ...
    Button("💬 Chat with Employer", "chat-btn", { click: () => startChatWithEmployer(baitoid) }, "btn btn-secondary"),
    Button("📎 Upload Resume", "upload-resume-btn", { click: () => uploadResumeFeature() }, "btn btn-secondary"),
    Button("⭐ Leave Review", "leave-review-btn", { click: () => leaveReview(baitoid) }, "btn btn-secondary")
  ]);
}
...
export async function displayBaito(isLoggedIn, baitoid, contentContainer) {
  ...
  try {
    ...
    section.appendChild(isOwner ? renderOwnerControls(baito) : renderApplicantControls(baito, baitoid, isLoggedIn));
