...
export function renderBookProduct(product, isLoggedIn, productType, productId, container) {
  let quantity = 1;
  ...
  const details = [
    ...
    createElement("p", {}, [product.author ? `Author: ${product.author}` : ""]),
    createElement("p", {}, [product.description]),
    createElement("p", {}, [`Price: ₹${product.price.toFixed(2)} / copy`]),
