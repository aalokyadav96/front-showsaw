...
export function renderToolProduct(product, isLoggedIn, productType, productId, container) {
  let quantity = 1;
  ...
  return createElement("div", { class: "product-page" }, [imageGallery, productDetails]);
}
